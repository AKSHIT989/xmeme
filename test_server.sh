...
git clone https://gitlab.crio.do/COHORT_ME_BUILDOUT_XMEME_ENROLL_1612436694845/sonejiakshit989-me_buildout_xmeme.git
cd sonejiakshit989-me_buildout_xmeme
chmod +x install.sh
...
curl --location --request GET 'http://localhost:8081/api-docs/'